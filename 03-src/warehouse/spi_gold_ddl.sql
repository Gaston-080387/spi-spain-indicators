/* =====================================================================
   ...
   ADR-002  Derived measures (YoY / MoM / YTD / QTD) are modeled as DAX
            ...
            Direct Lake). Consequence: spi_dim_measure and fact.measure_key are
...
ALTER TABLE dbo.spi_dim_indicator
    ADD CONSTRAINT PK_dim_indicator
    PRIMARY KEY NONCLUSTERED (indicator_key) NOT ENFORCED;
GO
...
ALTER TABLE dbo.spi_dim_region
    ADD CONSTRAINT PK_dim_region PRIMARY KEY NONCLUSTERED (region_key) NOT ENFORCED;
...
ALTER TABLE dbo.spi_dim_calendar
    ADD CONSTRAINT PK_dim_calendar PRIMARY KEY NONCLUSTERED (calendar_key) NOT ENFORCED;
...
ALTER TABLE dbo.spi_dim_source
    ADD CONSTRAINT PK_dim_source PRIMARY KEY NONCLUSTERED (source_key) NOT ENFORCED;
...
ALTER TABLE dbo.spi_fact_indicators
    ADD CONSTRAINT PK_fact_indicators PRIMARY KEY NONCLUSTERED
    (indicator_key, region_key, calendar_key, source_key) NOT ENFORCED;

ALTER TABLE dbo.spi_fact_indicators
    ADD CONSTRAINT FK_fact_indicator FOREIGN KEY (indicator_key)
    REFERENCES dbo.spi_dim_indicator (indicator_key) NOT ENFORCED;

ALTER TABLE dbo.spi_fact_indicators
    ADD CONSTRAINT FK_fact_region FOREIGN KEY (region_key)
    REFERENCES dbo.spi_dim_region (region_key) NOT ENFORCED;

ALTER TABLE dbo.spi_fact_indicators
    ADD CONSTRAINT FK_fact_calendar FOREIGN KEY (calendar_key)
    REFERENCES dbo.spi_dim_calendar (calendar_key) NOT ENFORCED;

ALTER TABLE dbo.spi_fact_indicators
    ADD CONSTRAINT FK_fact_source FOREIGN KEY (source_key)
